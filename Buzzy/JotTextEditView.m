...
- (instancetype)init
{
    if ((self = [super init])) {
        ...
        _font = [UIFont BerkshireSwash:22];
        _fontSize = 22.0f;
        
        _textEditingInsets = UIEdgeInsetsMake(hauteurIphone/2, 0.f, 0.f, 0.f);
        
        _textContainer = [UIView new];
        _textContainer.backgroundColor =[UIColor redBuzzy];
        ...
        self.textView.backgroundColor = [UIColor yellowBuzzy];
